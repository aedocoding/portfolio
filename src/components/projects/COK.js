        ...
        <div className={classes.cardDetails}>
          <CardContent>
            ...
            <Typography>
              <Link
                color="secondary"
                href="https://apps.apple.com/us/app/connect-our-kids/id1471038972?mt=8"
              >
                App Store
              </Link>
            </Typography>
            <Typography>
              ...
              <Typography>
                <Link
                  color="secondary"
                  href="https://trello.com/b/CAIeAMhU/labs23-connect-our-kids"
                >
                  Trello Board
                </Link>
              </Typography>
      ...
      <div>
        ...
        <Typography>
          <li>
            ...
            point but had not yet been deployed to the App Store or Google Play.
            Our job was to make the mobile app achieve feature parity with the
